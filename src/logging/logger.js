...
function getLogger(moduleName) {
    return {
        debug: (message, meta) => getManager().write("debug", moduleName, message, meta),
        info: (message, meta) => getManager().write("info", moduleName, message, meta),
        warn: (message, meta) => getManager().write("warn", moduleName, message, meta),
        error: (message, meta) => getManager().write("error", moduleName, message, meta),
    };
}
