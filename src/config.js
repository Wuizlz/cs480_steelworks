...
const inferredNodeEnv = process.env.NODE_ENV ?? (process.env.JEST_WORKER_ID ? "test" : "development");
...
const envSchema = v3_1.z.object({
    ...
    NODE_ENV: v3_1.z
        ...
        .optional()
        .default("development"),
    LOG_LEVEL: v3_1.z.enum(["debug", "info", "warn", "error", "silent"]).optional(),
...
exports.config = {
    ...
    logging: {
        ...
        consoleLevel: parsed.data.LOG_CONSOLE_LEVEL ??
