...
function createReportRouter(pool) {
  ...
  router.get(
    ...
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
      ...
      if (
        !(0, date_1.parseIsoDateUTC)(rangeStart) ||
        !(0, date_1.parseIsoDateUTC)(rangeEnd)
      ) {
      ...
      const summary = await (0, reportService_1.getWeeklySummary)(
        pool,
        rangeStart,
        rangeEnd,
      );
  ...
  router.get(
    ...
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
      ...
      const details = await (0, reportService_1.getWeeklyDetails)(
        pool,
        weekStart,
        lineName,
        defectType,
  ...
  router.get(
    ...
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
      ...
      const flags = await (0, reportService_1.getFlagCounts)(
        pool,
        rangeStart,
        rangeEnd,
      );
