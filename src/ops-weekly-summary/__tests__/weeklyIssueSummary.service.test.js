...
const _service = new service_1.WeeklyIssueSummaryService({
...
describe("WeeklyIssueSummaryService", () => {
    ...
    test.todo("AC2: includes Week, Production Line, Defect Type, and Total Defects per row");
    ...
    test.todo("AC5: excludes missing/invalid Lot ID records and flags as Unmatched Lot ID");
    ...
    test.todo("AC8: excludes records missing required fields and flags as Incomplete Data");
    test.todo("AC9: normalizes production line and defect type labels for consistency");
